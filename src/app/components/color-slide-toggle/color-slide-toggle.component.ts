...
@Component({
  selector: 'app-color-slide-toggle',
  templateUrl: './color-slide-toggle.component.html',
  styleUrl: './color-slide-toggle.component.css'
})
export class ColorSlideToggleComponent implements AfterViewInit {
  ...
  public changeColor(lightMode: boolean) {
