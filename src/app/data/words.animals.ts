...
export const FLORA: Word[] = [
  { translationKey: "scenery", hanzi: '风景', pinyin: 'fēngjǐng', composition: [], type: [WORD_TYPE.NOUN]},
  ...
  { translationKey: "beach", hanzi: '海边', pinyin: 'hǎibiān', composition: [], type: [WORD_TYPE.NOUN]},
...
export const WEATHER: Word[] = [
  { translationKey: "weather", hanzi: '天气', pinyin: 'tiānqì', composition: [], type: [WORD_TYPE.NOUN]},
  { translationKey: "raining", hanzi: '下雨', pinyin: 'xiàyǔ', composition: [], type: [WORD_TYPE.VERB]},
  { translationKey: "snowing", hanzi: '下雪', pinyin: 'xiàxuě', composition: [], type: [WORD_TYPE.VERB]},
  { translationKey: "snow", hanzi: '雪', pinyin: 'xuě', composition: ['雨', '彐'], type: [WORD_TYPE.NOUN]},
  { translationKey: "cloudy", hanzi: '阴天', pinyin: 'yīn tiān', composition: [], type: [WORD_TYPE.ADJECTIVE]},
  ...
  { translationKey: "forecast", hanzi: '预报', pinyin: 'yùbào', composition: [], type: [WORD_TYPE.NOUN]},
  { translationKey: "temperature", hanzi: '气温', pinyin: 'qìwēn', composition: [], type: [WORD_TYPE.NOUN]},
  ...
  { translationKey: "season", hanzi: '季节', pinyin: 'jìjié', composition: [], type: [WORD_TYPE.NOUN]},
  ...
  { translationKey: "summer", hanzi: '夏天', pinyin: 'xiàtiān', composition: [], type: [WORD_TYPE.NOUN]},
  ...
  { translationKey: "winter", hanzi: '冬天', pinyin: 'dōngtiān', composition: [], type: [WORD_TYPE.NOUN]},
